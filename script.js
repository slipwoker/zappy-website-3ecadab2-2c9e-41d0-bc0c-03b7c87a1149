                ...
                (async function() {
                    try {
                        ...
                        const response = await fetch('http://localhost:5001/api/email/contact-form', {
                            ...
                            body: JSON.stringify({
                                websiteId: '3ecadab2-2c9e-41d0-bc0c-03b7c87a1149',
                                name: formData.name,
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "My Shoes משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
